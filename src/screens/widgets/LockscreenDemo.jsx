    ...
    <div onClick={onClose} style={{
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 12 }}>
          <span style={{ width: 26, height: 26, borderRadius: 8, background: "rgba(0,255,135,0.14)", border: "1px solid rgba(0,255,135,0.35)", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'Poppins',system-ui,sans-serif", fontWeight: 800, fontSize: 14.5, color: "#00FF87" }}>A</span>
        ...
        <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", gap: 12 }}>
          <div style={{ minWidth: 0 }}>
            <div style={{ fontFamily: "'Poppins',system-ui,sans-serif", fontWeight: 800, fontSize: 27, textTransform: "uppercase", color: "#F4EFE6", lineHeight: 1, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>
