...
const imgPlaceholder =
  ...
  encodeURIComponent(
    '<svg xmlns="http://www.w3.org/2000/svg" width="200" height="140"><rect width="200" height="140" fill="#1a1f1a"/><text x="100" y="75" fill="#3B8FE0" font-size="13" text-anchor="middle" font-family="sans-serif">📷 photo</text></svg>'
  )
