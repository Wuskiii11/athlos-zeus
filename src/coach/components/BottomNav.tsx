...
export default function BottomNav({ active, onChange }: { active: Tab; onChange: (t: Tab) => void }) {
  ...
  return (
    <nav className="nav">
      {/* WHOOP layout: the tabs live in their own rounded pill; the AI logo
          button floats separately to the right with clear space between. */}
      ...
      {/* AI — round ATHLOS-logo button, separate from the pill. Same diameter
          as the pill height, logo enclosed in its own thin ring (WHOOP-style). */}
      <button
